...
describe("PruebaClaveAreaPreguntaDistractorDAO - Offline Tests (Servidor Apagado)", function () {
  let cut;
  const idFicticio = "123e4567-e89b-12d3-a456-426614174000";

  before(function () {
    cut = new PruebaClaveAreaPreguntaDistractorDAO(idFicticio, idFicticio, idFicticio);
  });

...
describe("PruebaClaveAreaDAO Integration Tests - Online", function () {
  let cut;
  let tipoPruebaDAO;
  let pruebaDAO;
  let pruebaClaveDAO;
  ...
  describe("Method: create()", function () {
    ...
    it("Debe rechazar si el Área no existe y lanzar un (404)", function (done) {
      ...
      pruebaClaveAreaInvalida.idPruebaClave = pruebaClaveAreaBase.idPruebaClave;
    ...
    it("Debe rechazar cuando falta el idArea (400)", function (done) {
      ...
      pruebaClaveAreaSinArea.idPruebaClave = pruebaClaveAreaBase.idPruebaClave;

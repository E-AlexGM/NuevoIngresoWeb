...
describe("DistractorAreaDAO Integration Tests - Online", function () {
  let cut;
  let distractorDAO;
  let areaDAO;
    ...
    if (idDistractorAreaCreado) {
      promesasLimpieza.push(
        cut
          ...
          .catch(() => console.warn("DistractorArea ya estaba eliminado")),
      );
    }
  ...
  describe("Method: create()", function () {
    ...
    it("Debe rechazar si el Área no existe y lanzar un (404)", function (done) {
      ...
      distractorAreaInvalido.idArea = {
        idArea: "123e4567-e89b-12d3-a456-426614174000",
      };

...
suite("PruebaJornadaAulaAspiranteOpcionExamenDAO Unit Test", function () {
    ...
    suite("create()", function () {
        test("Debe delegar la llamada a _create con el objeto recibido", function () {
            ...
            const pruebaJornadaAulaAspiranteOpcionExamen = { puntaje: 95 };

            cut.create(pruebaJornadaAulaAspiranteOpcionExamen);
    ...
    suite("update()", function () {
        test("Debe delegar la llamada a _update con los parámetros recibidos", function () {
            ...
            const idParam = "123";
            const pruebaJornadaAulaAspiranteOpcionExamen = { puntaje: 100 };

            cut.update(idParam, pruebaJornadaAulaAspiranteOpcionExamen);
